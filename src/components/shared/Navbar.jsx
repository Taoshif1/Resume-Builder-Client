        ...
        <div className="navbar-start">
          ...
          <div className="dropdown">
            ...
            >
              ...
              <li>
                <Link to="/get-started" className="text-[#464554] font-medium px-4 py-2">
                  Login
                </Link>
              </li>
            </ul>
          ...
          <Link to="/" className="text-[22px] font-bold text-[#0F172A] tracking-normal hover:opacity-80 transition-opacity whitespace-nowrap">
